<%@ Page Title="" Language="C#" MasterPageFile="~/PatientMasterPage.master" AutoEventWireup="true" CodeFile="Patientregistration.aspx.cs" Inherits="Patientregistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr style="width:1000px;height:50px">
        ...
        <td style="width:250px">
            <asp:Button ID="Add" runat="server" Text="Register" Width="142px" 
            Font-Names="Arial Black" 
            Font-Size="Small" ForeColor="White"  BackColor="#1A5276 "  BorderColor="#000066"
